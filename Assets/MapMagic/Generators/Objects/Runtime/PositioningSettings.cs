...
namespace MapMagic.Nodes.ObjectsGenerators
{
	...
	/// Contains the classical PRS settings for placing both trees and objects (for brush too)
	{
		...
		public PositioningSettings () {} //for serialization

		public PositioningSettings (ObjectsOutput output)
		{ 
			objHeight=output.objHeight; relativeHeight=output.relativeHeight; guiHeight=output.guiHeight; 
			useRotation=output.useRotation; takeTerrainNormal=output.takeTerrainNormal; rotateYonly=output.rotateYonly; regardPrefabRotation=output.regardPrefabRotation; guiRotation=output.guiRotation; 
			useScale=output.useScale; scaleYonly=output.scaleYonly; regardPrefabScale=output.regardPrefabScale; guiScale=output.guiScale; 
		}

		public PositioningSettings (TreesOutput output)
		{ 
			objHeight=output.objHeight; relativeHeight=output.relativeHeight; guiHeight=output.guiHeight; 
			useRotation=output.useRotation; takeTerrainNormal=output.takeTerrainNormal; rotateYonly=output.rotateYonly; regardPrefabRotation=output.regardPrefabRotation; guiRotation=output.guiRotation; 
			useScale=output.useScale; scaleYonly=output.scaleYonly; regardPrefabScale=output.regardPrefabScale; guiScale=output.guiScale; 
