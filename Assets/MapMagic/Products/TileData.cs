...
namespace MapMagic.Products
{
	...
	public class TileData
	{
		...
		#region Hierarchy
			...
			public TileData CreateSubData (ulong biomeId, MatrixWorld mask)
			...
			public TileData CreateSubData (ulong biomeId)  =>  CreateSubData(biomeId, this.biomeMask);
		...
		{
			HashSet<ulong> unitsIds = new HashSet<ulong>(); //TODO: cache id-to-gen, input id, relevant, etc. in graph
