...
namespace MapMagic.Terrains.GUI
{
	public static class PinDraw
	{
		...
		public enum SelectionMode { none, pin, pinLowres, pinExisting, selectPreview, export, exportCopy, unpin }
		...
		public static void DrawInspectorGUI (MapMagicObject mapMagic, ref SelectionMode selectionMode)
		{
			...
			Cell.EmptyLinePx(5);
			using (Cell.LinePx(25)) DrawPinButton(ref selectionMode, SelectionMode.export, "MapMagic/Icons/Export", "MapMagic/PinButtons/ExportTop", "Save Terrain Data", previewButtonColor, iconScale:0.5f);
			using (Cell.LinePx(25)) DrawPinButton(ref selectionMode, SelectionMode.exportCopy, "MapMagic/Icons/ExportCopy", "MapMagic/PinButtons/ExportBottom", "Save As Copy", previewButtonColor, iconScale:0.5f);
		...
		private static void DrawPinButton (ref SelectionMode selectionMode, SelectionMode buttonMode, string iconName, string buttonName, string label, Color color, float iconScale=1f)
		{
